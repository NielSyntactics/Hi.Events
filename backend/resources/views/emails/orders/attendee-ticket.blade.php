...
{{ __('Congratulations! Your order for :eventTitle was successful. Please find your details below.', ['eventTitle' => $event->getTitle()]) }}
@endif
...
<div style="font-size: 17px; font-weight: 600; color: #166534; margin-bottom: 8px;">{{ __('Your Ticket') }}</div>
<div style="font-size: 14px; color: #15803d; margin-bottom: 16px;">{{ __('Attendee: :name', ['name' => $attendee->getFullName()]) }}</div>
<x-mail::button :url="$ticketUrl" style="background-color: #16a34a;">
{{ __('View Ticket') }}
</x-mail::button>
</div>
